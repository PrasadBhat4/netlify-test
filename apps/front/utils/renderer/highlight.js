...
hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (e) {
      ...
      return (
        (i.disableAutodetect = !1), (i.name = 'C++'), (i.aliases = ['cc', 'c++', 'h++', 'hpp', 'hh', 'hxx', 'cxx']), i
      );
    };
  })()
);
    ...
    return function (e) {
      var t = "[a-zA-Z_\\-!.?+*=<>&#'][a-zA-Z_\\-!.?+*=<>&#'0-9/;:]*",
        ...
        g = {
          ...
          contains: [{ className: 'title', begin: t, relevance: 0, excludeEnd: !0, endsParent: !0 }].concat(y),
        };
      return (
...
hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (e) {
      ...
      return (
        (o.contains = [{ className: 'name', variants: [{ begin: n }, { begin: '\\|[^]*?\\|' }] }, u]),
