...
## Updated: Sept 1st, 2024

**1.     INTRODUCTION**

CodeRabbit Inc. (“**CodeRabbit**”,” **we**”, “**our**”, or “**us**”) respects your privacy and are committed to protecting it through our compliance with this Privacy Policy (“**Policy**”). A core element of our mission is our commitment to protect your personal information and to be transparent about the data we collect about you, how it is used, and with whom it is shared.

This Policy describes our practices for collecting, using, maintaining, protecting, and disclosing your information through [http://coderabbit.ai](http://coderabbit.ai/) (our “**Website**”), our applications (our “**Apps**”) and our products, services, technology platforms and related applications (collectively, the “**Service(s)**”).
...
·      **Personal Information:** In the course of registering an account on our Services, we collect information that identifies you as a specific individual and can be used to contact or identify you (“**Personal Information**”). Examples of Personal Information we collect for these purposes include your name and email.

·      **Payment Information:** We may also process your payment information, such as credit card, billingaddress, and other financial information necessary to purchase or otherwise use our Services. Please note that we do not collect or store your Payment Information. Rather your Payment Information is collected and stored by our Authorized Service Providers (see **HOW WE DISCLOSE AND SHARE YOUR INFORMATION** for more information on our Authorized Service Providers). By submitting your Payment Information, you consent to our providing your Payment Information to those Authorized Service Providers as are reasonably necessary to support and process your transactions as well as your credit card issuer and banking institution.

·      **User Contributions:** You may have the ability to interact with parts of our Website or with us through third-party platforms, such as the ability to post on third-party forums or to submit tickets on our Website. Your feedback or posts may be published or displayed publicly or transmitted to third parties (collectively, "**User Contributions**"). Your User Contributions are posted on and transmitted to others at your own risk. Additionally, we cannot control the actions of other users of the Website or third-party platforms with whom you may choose to share your User Contributions. Therefore, we cannot and do not guarantee that your User Contributions will not be viewed or accessed by unauthorized persons. Use precaution when posting any personal information online.

When you provide us with information in connection with a particular activity or otherwise sign up for our services or provide your contact information to us, including your email address in connection with that activity, product or service, you agree that such action constitutes a purchase or inquiry establishing a business relationship with us. You expressly consent to receiving communications from CodeRabbit through the information you provided to us. For more information on how to access and control your communication preferences, please see **YOUR RIGHTS AND CHOICES REGARDING YOUR INFORMATION,** below.

**Information Collected Automatically**

As you navigate through and interact with our Website, We and our third-party service providers, including analytics and third-party content providers, may automatically collect certain information from you whenever youaccess or interact with the Service.

·      **Usage Information.** Details of your visits to our Website, including which links you clicked on, contentresponse times, location data, logs, and other similar communication data and statistics about yourinteractions.
...
·      **Cookies:** Like many websites, we and our operational partners, affiliates, analytics, and service providersuse “cookies” to collect information. A cookie is a small data file that we transfer to your computer’s harddisk for record-keeping purposes. We use both persistent cookies that remain on your computer or similardevice (such as to save your registration ID and login password for future logins to the Service) andsession ID cookies, which expire at the end of your browser session (for example, to enable certainfeatures of the Service, to better understand how CodeRabbit Users interact with the Service and tomonitor aggregate usage by CodeRabbit Users and web traffic routing on the Service). You can control the use of cookies at the individual browser level, but if you choose to disable cookies, it may limit your use ofcertain features or functionality of the Service.

·      **Web Beacons:** We and our operational partners, affiliates, analytics, and service providers may also employsoftware technology known as “web beacons” and/or “tracking tags” to help us keep track of what content onour Service is effective and to serve relevant advertising to you. Web beacons are small graphics with a uniqueidentifier that may be invisible to you, and which are used to track the online activity of Internet users. Webbeacons are embedded in the web pages you review or email messages you receive. Web beacons or similartechnologies may be used for a number of purposes, including, without limitation, to count visitors to ourService, to monitor how CodeRabbit Users navigate the Service, to count how many emails that were sentwere actually opened, or to count how many particular articles or links were actually viewed.

·      **Embedded Scripts:** We and our operational partners, affiliates, analytics, and service providers mayalso employ software technology known as an Embedded Script. An Embedded Script is programmingcode that is designed to collect information about your interactions with the Service, such as the links youclick on. The code is temporarily downloaded onto your computer or other device and is deactivated ordeleted when you disconnect from the Service.

**Information Received from Third Parties.** 

We also may receive information about you from third parties. For example, we and our partners, affiliates andservice providers may use a variety of other technologies (such as tags) that collect statistical data relating to your Website activity for security and fraud detection purposes. 
...
·       **GitHub/GitLab/Azure DevOps Details** : We may collect data necessary to enable your CodeRabbit account to interface with your GitHub account, such as your GitHub token, your user organization, your GitHub username, and your user role. We integrate tightly with GitHub's API and Open Authentication (OAUTH) system. We do not have access to your GitHub/GitLab/Azure DevOps credentials.
...
2.  To perform code reviews, provide actionable suggestions, and enhance your development workflow.
...
6.  To tailor content we display to you and offer we may present to you, both on the Service and elsewhere online.
    
7.  To communicate with you, and to promote products, services, offers, and events offered by CodeRabbit.
    
8.  To comply with legal requirements and assist law enforcement.
    
9.  To stop any activity, we may consider to be, or to pose a risk of being, illegal, fraudulent, unethical or a legally actionable activity.
    
10.  To identify CodeRabbit users.
    
11.  For the purposes disclosed at the time you provide your information, and
...
1.  **Contractual Necessity:** To provide you with the CodeRabbit Service and perform the contract that you have with us.
    
2.  **Legitimate Interests:** It is in our legitimate interests to improve and analyze our Service, promote our products, prevent fraudulent transactions, maintain security of our Services, and provide functionality.
    
3.  **Consent:** In instances where we have indicated we will ask for consent within this Privacy Policy, you may withdraw your consent at any time by contacting us. Please see the **How to Contact Us** section for more information.
...
o   **GitHub and GitLab** for code containment.

\-       GitHub’s privacy policy is available [here](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement).

o   **Jira** for project management;

\-       Jira’s privacy policy is available [here](https://www.atlassian.com/legal/privacy-policy#what-this-policy-covers).  

o   **Linear** for productivity; and

\-       Linear’s privacy policy is available [here](https://linear.app/privacyopen).

o   **OpenAI** for performing code reviews.

\-       OpenAI’s privacy policy is available [here](https://openai.com/policies/privacy-policy).

o   **Anthropic** for performing code reviews.

\-       OpenAI’s privacy policy is available [here](https://www.anthropic.com/legal/privacy).

\-       Neither CodeRabbit nor OpenAI or Anthropic uses personal information collected as part of the code review to train, refine, or otherwise influence our models or any third-party models. Our commitment is to use the data solely for the purpose of reviewing the code in accordance with the user's request, and no other utilization takes place. The above representation does not apply to open-source projects (OSS). We use OSS to train our systems.
...
**Contact Us:** You may contact us to access, update or delete your personal information by contacting us at [contact@coderabbit.ai](mailto:contact@coderabbit.ai).  
...
Under the General Data Protection Regulation (GDPR), CodeRabbit may be considered a data controller to the extent that we process personal information directly from European residents. To the extent that CodeRabbit is a data controller, European residents may access, correct, update or delete your personal information; object to our processing of this information, ask us to restrict our processing of your personal information, or request portability of your personal information by accessing the account settings within the App or by contacting us at [contact@coderabbit.ai](mailto:contact@coderabbit.ai).
...
 Please note that our Services require a minimum amount of Personal Information in order to function. European residents who do not provide Personal Information (e.g., by not creating an account) may not be able to access the full functionality of features found on CodeRabbit.
...
CodeRabbit stores certain data to improve the reviews refining the reviews to align with your preferences. You can opt out of data storage. The stored data primarily consists of vector embeddings, which are used to refine and personalize future reviews. The data storage is compliant with SOC2 Type II, GDPR, and HIPAA regulations. We ensure the utmost confidentiality and security of the data stored. You can opt out of data storage at any time.

 **13.  CHANGES TO THIS POLICY**

CodeRabbit may update this Privacy Policy at any time and any changes will be effective upon posting. In the event that there are material changes to the way we treat your Personal Information, we will update the **Last Modified** date at the top of this Policy upon becoming effective. We may also notify you by email, in our discretion.

**14.  HOW TO CONTACT CODERABBIT**

Data protection officer has been appointed and can be reached out at [dpo@coderabbit.ai](mailto:dpo@coderabbit.ai) for any questions.
