...
const Form = ({ data, success }: Readonly<Props>) => {
  ...
  const [formValues, setFormValues] = useState<z.infer<typeof schema>>({
    ...
    '0-1/email': '',
    '0-1/jobtitle': '',
    // Note: this field is not mapped on Strapi form
    '0-1/partner_text': '',
  });
  ...
  const submitHandler = async (e: React.SyntheticEvent) => {
    ...
    const formGuid = process.env.NEXT_PUBLIC_HUBSPOT_PARTNERSHIP_FORM_GUID ?? '';
    ...
    const formDataToSend = {
      ...
      fields: mappedFields,
      context: {
        pageUri: window?.location?.href ?? 'https://coderabbit.ai/partnership',
    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='flex flex-wrap w-full'>
        ...
        <TextField
          ...
          isTextarea
          isRequired
          hasError={!!errors['0-1/partner_text']}
          message={errors['0-1/partner_text']}
          name='0-1/partner_text'
          handleChange={handleChange}
          className='w-full mt-8'
        />
      </div>
