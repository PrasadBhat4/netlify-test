...
import { HandleChangeType, StrapiFormContactUs, StrapiSuccess } from '@/app/lib/types';
import { GDPRConsentText } from '../GDPRConsentText';

interface Props {
  data: StrapiFormContactUs;
...
const Form = ({ data, success }: Readonly<Props>) => {
    ...
    '0-2/number_of_developers':
      data?.NumberOfDevelopers?.isRequired === true
        ? z
            ...
            .toLowerCase()
        : z.string().optional(),
    '0-1/how_can_we_help_':
      data?.HowCanWeHelp?.isRequired === true
        ? z
            .string({
              required_error: 'This field is required',
              invalid_type_error: 'This field must be a string',
  ...
  const submitHandler = async (e: React.SyntheticEvent) => {
    ...
    const formDataToSend = {
      ...
      fields: mappedFields,
      context: {
        pageUri: window?.location?.href ?? 'https://coderabbit.ai/contact-us/sales',
        pageName: 'Contact Us Sales',
      },
    };
    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='flex flex-wrap w-full'>
        ...
        <SelectField
          ...
          hasError={!!errors['0-2/number_of_developers']}
          message={errors['0-2/number_of_developers']}
          name='0-2/number_of_developers'
          handleChange={handleChange}
          className='w-full mt-8'
        />
        <TextField
          ...
          hasError={!!errors['0-1/how_can_we_help_']}
          message={errors['0-1/how_can_we_help_']}
          name='0-1/how_can_we_help_'
          handleChange={handleChange}
          className='w-full mt-8'
        />
      </div>
