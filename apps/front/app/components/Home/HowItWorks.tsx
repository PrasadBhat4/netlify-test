...
const HowItWorks = ({ data = {} }: Readonly<Props>) => {
  ...
  return (
    <Container>
      <InnerContainer>
        <div className='py-11 px-6 md:py-12 lg:px-12 lg:py-14 xl:p-14 border rounded-[2.5rem] md:max-xl:rounded-[3rem] xl:rounded-[3.5rem] bg-neutral-0 dark:bg-neutral-900 border-cream-600 dark:border-neutral-800'>
